...
##  Important Usage Tips (For Best Results)
...
When viewing a candidate, use the **eSearch** tab to verify research papers via CrossRef and PubMed APIs. This is a  module that confirms the credibility of the candidate's claims.
